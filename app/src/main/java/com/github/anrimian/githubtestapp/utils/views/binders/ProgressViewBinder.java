...
public class ProgressViewBinder {
    ...
    public ProgressViewBinder(View view) {
        ...
        ivEmpty = (ImageView) view.findViewById(R.id.psv_iv_empty);
    }

    public ProgressViewBinder(ProgressBar progressBar, TextView tvMessage, View btnTryAgain, ImageView ivEmpty) {
